        ...
        <footer className="bg-muted text-primary">
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 className="font-bold text-lg mb-4">Proxy</h3>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/privacy" className="text-sm text-primary hover:text-primary/90">Privacy Policy</Link></li>
                            <li><Link href="/cookies" className="text-sm text-primary hover:text-primary/90">Cookie Policy</Link></li>
                        </ul>
                    </div>
                    <div>
                ...
                <div className="mt-8 pt-8 border-t border-gray-200">
                    <p className="text-sm text-center">&copy; {new Date().getFullYear()} Proxy. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
