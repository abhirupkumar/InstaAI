        ...
        <>
            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="prose max-w-none">
                    ...
                    <p>To provide the Services, we collect and have collected over the past 12 months personal information about you from a variety of sources, as set out below. The information that we collect and uses varies depending on how you interact with us.</p>
                    ...
                    <h2 className="text-2xl font-semibold mt-6 mb-4">What Personal Information We Collect</h2>
                    ...
                    <h3 className="text-xl font-semibold mt-4 mb-2">Information We Collect Directly from You</h3>
                    ...
                    <h3 className="text-xl font-semibold mt-4 mb-2">Information We Collect through Cookies</h3>
                    ...
                    <h3 className="text-xl font-semibold mt-4 mb-2">Information We Obtain from Third Parties</h3>
